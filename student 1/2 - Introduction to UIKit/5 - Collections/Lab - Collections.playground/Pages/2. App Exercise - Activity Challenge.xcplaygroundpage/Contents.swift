 ...
 */
var walkChallenges: [String] = ["walk for at least 25 min", "walk in the morning"]
var runningChallenges: [String] = ["Run 5 times a week", "Run for 1km atleast"]
...
var challenges = [walkChallenges, runningChallenges]
